...
Este documento está estruturado da seguinte forma: no Capítulo \ref{ch:fundamentacao} é apresentada a fundamentação teórica do seu trabalho. No Capítulo \ref{ch:revisao} é encontrada a revisão do estado-da-arte. No Capítulo \ref{ch:proposta} é apresentada a proposta do trabalho. No Capítulo \ref{ch:resultados} são apresentados os resultados e análise dos resultados. Finalmente, no Capítulo \ref{ch:conclusao} apresentamos a conclusão e trabalhos futuros.
